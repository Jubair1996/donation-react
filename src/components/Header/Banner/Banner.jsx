const Banner = () => {
  return (
    <div className="relative grid h-[70vh] w-full  flex-col items-end justify-center overflow-hidden rounded-xl bg-white bg-clip-border text-center text-gray-700 mix-blend-multiply md:mix-blend-overlay">
